...
# The backfilled root_complete branch of the natural-exit path is covered by
...
# opus (v2 Section 0 item 3 Part B) - export MODEL so the children this
# suite launches still run at haiku, unaffected by that new default.
export MODEL="haiku"
