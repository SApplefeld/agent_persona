...
- The record is still `pending` (not delivered yet) or `skipped` (refused at delivery; the decision log names whether the writer had no live claim, the id was malformed, or the writer's persona name was)
