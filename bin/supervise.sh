...
while true; do
  ...
  # charter holds the clone to a plain https or ssh remote URL and puts the
  # operator's word ahead of a clone the operator did not name, where naming
  # the target before the push alone would guard a step the clone has already
  # taken. An ask that produces a file and
