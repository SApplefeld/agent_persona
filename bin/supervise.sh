...
while true; do
  ...
  # words. The wording is deliberately not CLAUDE.md's: the duplicate check in
  # .kit/injection-duplicate-test.mjs refuses a sentence of eight words or more
  # that both surfaces carry, and a copy would drift from its owner anyway.
