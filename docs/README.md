...
- `archive/agentic-plugin_self-review_v1.md`: Self-review (reactive lessons from the decision log, error-streak trigger, injected on the next prompt) (v0.10.0, commit 8461e1e). Complete.
