...
- `archive/agentic-plugin_commons_v1.md`: Commons (shared claims and coordination, first-claim-wins arbitration, epoch as write fence) (v0.9.0, commit 0cef0d4+). Complete.
