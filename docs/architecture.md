...
`.kit/injection-ledger.json` is the committed size baseline, 40 entries totalling 29,158 characters. Ten entries come from `bin/supervise.sh` and total 13,480; thirty come from `hooks/index.ts` and total 15,678, of which the fifteen registered tool descriptions are 11,270.
...
| The fifteen tool descriptions an owner-tier session registers | 11,270 |
