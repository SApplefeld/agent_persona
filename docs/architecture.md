...
`.kit/injection-ledger.json` is the committed size baseline, 40 entries totalling 29,181 characters. Ten entries come from `bin/supervise.sh` and total 13,480; thirty come from `hooks/index.ts` and total 15,701, of which the fifteen registered tool descriptions are 11,270.
